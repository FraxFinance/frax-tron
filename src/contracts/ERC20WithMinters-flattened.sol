...
// src/contracts/ERC20WithMinters.sol

// Ripped from
// https://github.com/FraxFinance/frax-contracts-dev/blob/travis/src/hardhat/contracts/ERC20/ERC20PermissionedMint.sol
// with the difference that minter cannot burn (no minter_burn_from())
...
contract ERC20PermissionedMint is ERC20, ERC20Burnable, Owned {
    ...
    ) ERC20(_name, _symbol) Owned(_creator_address) {
